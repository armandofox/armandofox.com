...
[computer-based testing at Berkeley](https://rtl.berkeley.edu/cbtf),
building on the work done with [Dan
Garcia](https://www.cs.berkeley.edu/~ddgarcia) on Mastery Learning and
A's For All.

I'm a musical theater fanatic and performer, and an aficionado of computing history and retro technology.
...
Learning](eecs.link/star) (with Dan Garcia, Narges Norouzi, Josh
Grossman, and others)
...
* March 2026: I'm now the [Area Editor for the "Broadening
Participation" area](https://cacm.acm.org/editorial-staff-board/) in Communications of the ACM.
...
episode of Fronteiras da Engenharia de Software with Prof. Adolfo
Neto, based on live interview in Brazil at CBSOFT 2025.
